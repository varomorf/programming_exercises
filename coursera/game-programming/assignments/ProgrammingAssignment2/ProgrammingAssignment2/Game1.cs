...
namespace ProgrammingAssignment2
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            sprite0 = Content.Load<Texture2D>(@"sprites\texture0");
            sprite1 = Content.Load<Texture2D>(@"sprites\texture1");
            sprite2 = Content.Load<Texture2D>(@"sprites\texture2");
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if (elapsedTime > ChangeDelayTime)
            {
                ...
                drawRectangle.X = (graphics.PreferredBackBufferWidth / 2) - (drawRectangle.Width / 2);
                drawRectangle.Y = (graphics.PreferredBackBufferHeight / 2) - (drawRectangle.Height / 2);
