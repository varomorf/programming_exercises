...
namespace ProgrammingAssignment3
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            rockSprite0 = Content.Load<Texture2D>(@"rocks\greenrock");
            rockSprite1 = Content.Load<Texture2D>(@"rocks\magentarock");
            rockSprite2 = Content.Load<Texture2D>(@"rocks\whiterock");
        }
