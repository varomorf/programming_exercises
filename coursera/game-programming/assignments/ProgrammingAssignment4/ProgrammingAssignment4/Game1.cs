...
namespace ProgrammingAssignment4
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            Vector2 location = new Vector2(WindowWidth/2, WindowHeight/2);
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            else if (mouse.RightButton == ButtonState.Released)
            {
                ...
                if (rightClickStarted)
                {
                    ...
                    Vector2 pickupPosition = mouse.Position.ToVector2();
                    pickups.Add(new Pickup(pickupSprite, pickupPosition));
